...
import xyz.pixelatedw.bizarremod.renderers.SunRenderer;
import xyz.pixelatedw.wypi.abilities.models.LightRayModel;
...
public class ModRenderers
{
	...
	public static void registerRenderers() 
    {
		...
		RenderingRegistry.registerEntityRenderingHandler(LightRayEntity.class, new AbilityProjectileRenderer.Factory(new LightRayModel()).setTexture("light_ray").setColor("f5b642"));
		...
		RenderingRegistry.registerEntityRenderingHandler(SunEntity.class, new SunRenderer.Factory());
