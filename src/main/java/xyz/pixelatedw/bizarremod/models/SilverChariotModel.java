...
public class SilverChariotModel extends BipedModel<GenericStandEntity>
{
	...
	public RendererModel right_arm_armor_top_1;
	public RendererModel right_arm_armor_base_1;
	public RendererModel right_arm_armor_spike_0_1;
	public RendererModel right_arm_armor_spike_1_1;
	public RendererModel right_arm_armor_spike_3_1;
	public RendererModel right_arm_armor_spike_2_1;
	public RendererModel right_arm_armor_spike_4_1;
	...
	public SilverChariotModel()
	{
		...
		this.right_arm_armor_top_1 = new RendererModel(this, 26, 5);
		this.right_arm_armor_top_1.setRotationPoint(1.0F, -0.5F, 0.0F);
		this.right_arm_armor_top_1.addBox(0.0F, -2.0F, -2.0F, 2, 4, 4, 0.0F);
		...
		this.right_arm_armor_spike_3_1 = new RendererModel(this, 23, 1);
		this.right_arm_armor_spike_3_1.setRotationPoint(0.5F, -0.6F, -2.0F);
		this.right_arm_armor_spike_3_1.addBox(0.0F, 0.0F, -2.0F, 1, 1, 2, 0.0F);
		...
		this.right_arm_armor_spike_0_1 = new RendererModel(this, 23, 1);
		this.right_arm_armor_spike_0_1.setRotationPoint(0.5F, -4.0F, -0.5F);
		this.right_arm_armor_spike_0_1.addBox(0.0F, 0.0F, 0.0F, 1, 2, 1, 0.0F);
		...
		this.right_arm_armor_spike_4_1 = new RendererModel(this, 23, 1);
		this.right_arm_armor_spike_4_1.setRotationPoint(0.5F, -1.8F, 1.3F);
		this.right_arm_armor_spike_4_1.addBox(0.0F, 0.0F, 0.0F, 1, 1, 2, 0.0F);
		this.setRotateAngle(right_arm_armor_spike_4_1, 0.7853981633974483F, 0.0F, 0.0F);
		...
		this.right_arm_armor_spike_1_1 = new RendererModel(this, 23, 1);
		this.right_arm_armor_spike_1_1.setRotationPoint(0.5F, -0.6F, 2.0F);
		this.right_arm_armor_spike_1_1.addBox(0.0F, 0.0F, 0.0F, 1, 1, 2, 0.0F);
		this.right_arm_armor_spike_2_1 = new RendererModel(this, 23, 1);
		this.right_arm_armor_spike_2_1.setRotationPoint(0.5F, -1.8F, -1.3F);
		this.right_arm_armor_spike_2_1.addBox(0.0F, 0.0F, -2.0F, 1, 1, 2, 0.0F);
		this.setRotateAngle(right_arm_armor_spike_2_1, -0.7853981633974483F, 0.0F, 0.0F);
		...
		this.right_arm_armor_base_1 = new RendererModel(this, 39, 8);
		this.right_arm_armor_base_1.setRotationPoint(0.0F, 4.0F, 0.0F);
		this.right_arm_armor_base_1.addBox(0.0F, -2.0F, -1.0F, 2, 3, 2, 0.0F);
		...
		this.left_arm.addChild(this.right_arm_armor_top_1);
		...
		this.right_arm_armor_top_1.addChild(this.right_arm_armor_spike_3_1);
		...
		this.right_arm_armor_top_1.addChild(this.right_arm_armor_spike_0_1);
		this.body.addChild(this.lower_body);
		this.right_arm_armor_top_1.addChild(this.right_arm_armor_spike_4_1);
		...
		this.right_arm_armor_top_1.addChild(this.right_arm_armor_spike_1_1);
		this.right_arm_armor_top_1.addChild(this.right_arm_armor_spike_2_1);
		this.right_arm_armor_top.addChild(this.right_arm_armor_spike_4);
		this.mid_body.addChild(this.mid_body_armor);
		this.right_arm_armor_top_1.addChild(this.right_arm_armor_base_1);
