...
public class MachineGunsAbility extends Ability
{
	...
	public void renderDescription(FontRenderer fontObj, int posX, int posY)
	{
		...
		fontObj.drawStringWithShadow("Aerosmith is equipped with small machine guns on its wings", posX + 70, posY + 115, -1);
		fontObj.drawStringWithShadow("shooting tracer bullets with infinite ammunition.", posX + 70, posY + 125, -1);	
	}
